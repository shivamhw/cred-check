...
output_file_free = "VYPrvpnAc_Free_" + \
    datetime.datetime.now().strftime("%d-%h-%H-%M")
output_file_paid = "VYPrvpnhAc_Premium_" + \
    datetime.datetime.now().strftime("%d-%h-%H-%M")
countFile = "."+sys.argv[0]+"_"+input_file+"_count"
proxy_file = sys.argv[2]
statusFile_name = "vypr.status"
loginURL = "https://api.goldenfrog.com/settings"
        ...
        while not q.empty():
            ...
            try:
                ...
                headv1 = {
                    ...
                    "X-GF-PRODUCT-VERSION": "4.3.3.11377",
